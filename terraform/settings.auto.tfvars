...
lambda_to_s3 = {
  ...
  AWS_EBS_CSI_DRIVER = {
    url    = "https://github.com/kubernetes-sigs/aws-ebs-csi-driver/releases/download/helm-chart-aws-ebs-csi-driver-2.13.0/aws-ebs-csi-driver-2.13.0.tgz"
    prefix = "data/downloads/charts/aws-ebs-csi-driver.tgz"
  }
  AWS_EFS_CSI_DRIVER = {
