...
export ARCH AWS_METADATA_TOKEN AWS_ADDON_URI AZ ECR_URI_PREFIX DB_PASS INSTANCE_ID K3S_TOKEN K3S_BIN_PATH K3S_BIN_FILE K3S_TAR_PATH K3S_TAR_FILE K3S_INSTALL_PATH K3S_INSTALL_FILE K3S_DATASTORE_ENDPOINT INSTALL_K3S_SKIP_DOWNLOAD HELM_BIN_FILE CHARTS_PATH POD_CIDR NAT_GATEWAYS VPC
